      ...
      >
        ...
        <View style={styles.content}>
          ...
          <View style={styles.pageHeader}>
            ...
            <Text style={styles.pageTitle}>เช็คข้อมูลชนิดยา</Text>
          </View>
              ...
              {selectedDrug && compatibilityGroups ? (
                ...
                >
                  ...
                  <View style={styles.selectedDrugChipRow}>
                    <View style={styles.selectedDrugChip}>
                      <Ionicons name="medkit" size={18} color="#0D9488" />
                      <Text style={styles.selectedDrugChipText}>
                ...
                <View style={styles.emptyState}>
                  ...
                  <Text style={styles.emptySubtext}>
                    กรุณาเลือกยาจากรายการด้านซ้ายเพื่อดูความเข้ากันได้กับยาอื่น
                  </Text>
                </View>
              )}
            </View>
